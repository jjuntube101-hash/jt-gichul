  ...
  return (
    ...
    >
      ...
      <body className="min-h-full flex flex-col bg-background text-foreground antialiased">
        <a href="#main-content" className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[100] focus:rounded-lg focus:bg-primary focus:px-4 focus:py-2 focus:text-white focus:text-sm">
          본문으로 건너뛰기
        </a>
        <AuthListener />
        <Header />
        <main id="main-content" className="mx-auto w-full max-w-2xl flex-1 px-4 py-6 pb-6">
          <ErrorBoundary>
            {children}
          </ErrorBoundary>
        </main>
